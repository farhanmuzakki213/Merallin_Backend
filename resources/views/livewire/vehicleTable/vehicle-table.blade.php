            ...
            <div class="max-w-full overflow-x-auto">
                <div class="min-w-[900px]">
                    ...
                    <div class="grid grid-cols-12 border-t border-gray-200 dark:border-gray-800">
                        <div class="col-span-4 flex items-center border-r border-gray-200 px-4 py-3 dark:border-gray-800" wire:click="sortBy('license_plate')">
                            <p class="cursor-pointer text-theme-xs font-medium text-gray-700 dark:text-gray-400">License Plate</p>
                        </div>
                        <div class="col-span-3 flex items-center border-r border-gray-200 px-4 py-3 dark:border-gray-800" wire:click="sortBy('model')">
                            <p class="cursor-pointer text-theme-xs font-medium text-gray-700 dark:text-gray-400">Model</p>
                        </div>
                        <div class="col-span-3 flex items-center border-r border-gray-200 px-4 py-3 dark:border-gray-800" wire:click="sortBy('type')">
                            <p class="cursor-pointer text-theme-xs font-medium text-gray-700 dark:text-gray-400">Type</p>
                        </div>
                    ...
                    @forelse ($vehicles as $vehicle)
                        <div class="grid grid-cols-12 border-t border-gray-100 dark:border-gray-800">
                            <div class="col-span-4 flex items-center border-r border-gray-100 p-3 dark:border-gray-800">
                                <p class="text-theme-sm font-medium text-gray-800 dark:text-white/90">{{ $vehicle->license_plate }}</p>
                            </div>
                            <div class="col-span-3 flex items-center border-r border-gray-100 p-3 dark:border-gray-800">
                                <p class="text-theme-sm text-gray-700 dark:text-gray-400">{{ $vehicle->model ?? '-' }}</p>
                            </div>
                            <div class="col-span-3 flex items-center border-r border-gray-100 p-3 dark:border-gray-800">
                                <p class="text-theme-sm text-gray-700 dark:text-gray-400">{{ $vehicle->type ?? '-' }}</p>
                            </div>
                            <div class="col-span-2 flex items-center px-4 py-3">
                                <div class="flex w-full items-center gap-2">
                                    <button wire:click="edit({{ $vehicle->id }})" class="text-gray-500 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white/90">
                                        {{-- SVG Edit Icon --}}
