                            ...
                            <div class="col-span-2 flex items-center px-4 py-3">
                                <div class="flex w-full items-center gap-2">
                                    @if ($trip->status_trip == 'tersedia')
                                        ...
                                        @endhasanyrole
                                        @hasrole('direksi')
                                            <p class="text-theme-xs rounded-full px-2 py-0.5 font-medium bg-success-50 text-success-700 dark:bg-success-500/15 dark:text-success-400">
                ...
                <div class="max-w-full overflow-x-auto">
                    <div class="min-w-[1100px] text-sm">
                        ...
                        <div class="grid grid-cols-12 border-t border-gray-200 font-medium text-gray-700 dark:border-gray-800 dark:text-gray-400">
                            ...
                            <div class="col-span-2 flex cursor-pointer items-center border-r p-3 dark:border-gray-800" wire:click="sortByDetail('created_at')">Tanggal</div>
                        ...
                        @forelse ($detailTrips as $trip)
                            <div class="grid grid-cols-12 border-t border-gray-100 dark:border-gray-800">
                                ...
                                <div class="col-span-2 flex items-center border-r p-3 text-xs dark:border-gray-800">
                                    <div>
                                        <p class="font-medium text-gray-800 dark:text-white/90" title="Tanggal Berangkat">
