        ...
        <nav>
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-4">
                    ...
                    <li>
                        <a href="{{ route('tables') }}" wire:navigate @class([
                            'menu-item group',
                            'menu-item-active' => request()->routeIs('tables'),
                            'menu-item-inactive' => !request()->routeIs('tables'),
                        ])>
                            <svg @class([
                                'menu-item-icon-active' => request()->routeIs('tables'),
                                'menu-item-icon-inactive' => !request()->routeIs('tables'),
                            ]) width="24" height="24" viewBox="0 0 24 24"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <span class="menu-item-text" :class="sidebarToggle ? 'lg:hidden' : ''">Tables</span>
                        </a>
                    </li>
                </ul>
            </div>
