                ...
                <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                    <a class="flex items-center gap-2 text-gray-700 dark:text-gray-400" href="#"
                        ...
                        <span class="h-11 w-11 overflow-hidden rounded-full">
                            <img src="{{ Auth::user()->profile_photo_path ? Storage::url(Auth::user()->profile_photo_path) : asset('images/user/owner.jpg') }}"
                                alt="User" />
                        </span>
                        <span class="hidden text-sm font-medium lg:block">{{ Auth::user()->name }}</span>
                        <svg :class="dropdownOpen && 'rotate-180'" class="hidden stroke-current lg:block"
                    ...
                    <div x-show="dropdownOpen"
                        ...
                        <div class="border-b border-gray-200 pb-3 dark:border-gray-800">
                            <span
                                class="text-theme-sm block font-medium text-gray-700 dark:text-gray-400">{{ Auth::user()->name }}</span>
                            <span
                                class="text-theme-xs mt-0.5 block text-gray-500 dark:text-gray-400">{{ Auth::user()->email }}</span>
                        </div>
